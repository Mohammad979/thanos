...
class Development(Config):
    ...
    APP_ID = 21083129
    API_HASH = "46f6c82fad537a7e306a2f1084dc0a62"
    ...
    STRING_SESSION = "1AZWarzUBu6eBGCnrVjPRBpSasjdNs6it99CdrBffCL1-3ff26xmbLkuKCHXmep1BEq36v1u9RJyayarllgWc5JsHpusy4gXb_wm76NJp2c84QqV9W1IbXqfAIQlql6WuwzMjUXEkJvHiuFnjWvQEolPaifC_hyzmJyzkAbe3Sl3AfRhiEJ8Qx0zJDYrYOSPoma4ylgS0s2-6HZ8aXHQoizs8oryVYFJBMHl0Qe2P8jUtuxxfe3S3SdfRXFM9YMiHQWoSeseDZM3AeaXBygIjlnix9dWMxnqVEld_MXATqPPi1N2yOOTfresgfoD-sQ3nEPX5esHs2fKw3RdoLng-XNOgcuQFnCU="# IF U DONT KNOW HOW TO MAKE THEN GO IN THANOS SUPPORT AND TYPE #session 
    # --------------------------------------------------
